...
using System.Linq;
using AgendaBuddy.Customer.Extensions;
...
namespace AgendaBuddy.Customer.Tests.Extensions;

/// <summary>
/// R-3 guards for Customer: one of seven services being left on the old configuration path is the
