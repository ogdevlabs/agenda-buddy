...
/// <summary>
/// <c>UnauthorizedAccessException</c> and <c>KeyNotFoundException</c> from the handler
/// both map to 403 in AgendaBuddy.Booking.Api, deliberately indistinguishably — a caller cannot tell "someone
