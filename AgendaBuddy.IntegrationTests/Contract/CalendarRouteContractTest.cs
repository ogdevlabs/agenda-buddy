...
/// <summary>
/// AC-5, Calendar: one real HTTP request through the real pipeline, asserting the status code
/// only. See <see cref="BookingRouteContractTest"/> for why status-only is the deliberate design
/// (ADR-017, <c>DataResponse&lt;T&gt;</c>).
/// </summary>
/// <remarks>
...
/// carry <c>.RequireAuthorization()</c> ahead of the ownership guard, so an anonymous caller is
