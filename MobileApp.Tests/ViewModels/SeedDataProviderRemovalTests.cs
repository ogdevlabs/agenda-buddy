...
/// longer exists in the MobileApp assembly (Services/SeedDataProvider.cs was deleted), which is a
...
public class SeedDataProviderRemovalTests
{
    ...
    public void SeedDataProviderType_NoLongerExistsInMobileAppAssembly()
    {
        ...
        var seedType = mobileAppAssembly.GetType("MobileApp.Services.SeedDataProvider");
