...
/// <summary>
/// The paginated envelope both list endpoints return. <b>This is a published contract</b>
/// (ADR-023, `api-contracts.md` §4).
/// </summary>
...
/// these routes (`01-api-surface.md:158`); doing it after a mobile client exists would mean writing it twice.
/// </para>
/// <para>
...
/// <em>would change this contract</em>. Revisit <b>before</b> real user data lands, not after — by then the
/// mobile client depends on this shape.
/// </para>
/// </remarks>
