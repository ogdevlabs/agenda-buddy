...
public class SecurityScanAndDockerJobShapeTest
{
    ...
    private static readonly string[] ExpectedMatrixServices =
        ["AgendaBuddy.Booking.Api", "AgendaBuddy.Calendar.Api", "AgendaBuddy.Customer.Api", "AgendaBuddy.Provider.Api", "AgendaBuddy.Services.Api", "AgendaBuddy.Profession.Api", "AgendaBuddy.Identity"];
