...
/// <summary>
/// Pins F-016 AC-1: the audit-persistence types live in <c>EventAndCommands.Persistence</c>,
...
/// <c>using EventAndCommands.Persistence;</c> directive. A direct reference would not compile
...
{
    private const string CorrectNamespace = "EventAndCommands.Persistence";
