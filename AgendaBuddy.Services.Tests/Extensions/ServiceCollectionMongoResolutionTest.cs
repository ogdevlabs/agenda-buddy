...
namespace AgendaBuddy.Services.Tests.Extensions;

/// <summary>
/// R-3 guards for Services: one of seven services being left on the old configuration path is the
...
public class ServiceCollectionMongoResolutionTest
{
    ...
    private static IConfiguration LegacyOnly() =>
        Config(("MongoDB:ConnectionString", "mongodb://localhost:27017"),
            ...
            ("MongoDB:ServicesCollection", "legacy_servicescollection"));
    ...
    public void AddMongoDbRepository_RegistersRepositories_FromAspireConfigurationAlone()
    {
        ...
        Assert.NotNull(scope.ServiceProvider.GetService<IRepository<ServiceEntity>>());
    }
