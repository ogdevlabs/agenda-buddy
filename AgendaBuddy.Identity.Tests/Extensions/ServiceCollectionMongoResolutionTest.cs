...
namespace AgendaBuddy.Identity.Tests.Extensions;

/// <summary>
/// R-3 guards for Identity: one of seven services being left on the old configuration path is the
...
public class ServiceCollectionMongoResolutionTest
{
    ...
    private static IConfiguration LegacyOnly() =>
        Config(("MongoDbSettings:ConnectionString", "mongodb://localhost:27017"),
            ("MongoDbSettings:DatabaseName", "legacy_db"),
            ("MongoDbSettings:CollectionName", "legacy_collectionname"));
