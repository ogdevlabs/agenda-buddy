...
**Last updated:** 2026-08-23T04:10:00Z
...
> **F-016 shipped `v0.2.0`; F-021 shipped `v0.3.0`. F-014 is next.**
>
...
> for a system whose own roadmap says six features do not work yet: F-014 exists because six capabilities
> have no route, F-015 because the mobile client cannot reach the backend at all, and F-017 because three
> Dockerfiles cannot run. There is nothing deployable to deploy. Rotating the Atlas credential
> (`agenda-buddy-41s`) explicitly does **not** wait for this. The Priority column reflects this order; feature IDs are unchanged.
>
> Why this order:
