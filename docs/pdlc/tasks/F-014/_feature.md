...
SPLIT: slot correctness (Start<End, future-dating, overlap) moved to F-025 `booking-correctness` (agenda-buddy-ohw). It is a different shape of work needing its own concurrency design, and has no technical dependency on this feature. The roadmap's reason for bundling it was thematic, not technical.
