...
public class CalendarViewModelTests
{
    ...
    public async Task LoadAsync_Success_SetsDays()
    {
        ...
        {
            new() { Date = "2026-08-01", AvailableSlots = ["09:00", "10:00"], BookedSlots = [new BookedSlot("11:00 AM — bob@example.com", 45)] },
            new() { Date = "2026-08-02", AvailableSlots = [],                 BookedSlots = [new BookedSlot("09:00 AM — bob@example.com", null)] }
        };
