using AgendaBuddy.Customer.Api.Modules;
...
builder.Services.AddCarter(configurator: c => c.WithModule<CustomerModule>().WithModule<MessageModule>().WithModule<NotificationModule>());
