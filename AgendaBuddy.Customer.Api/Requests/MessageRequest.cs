...
/// </para>
/// <para>
/// F-020-T12: this route (<c>POST /api/v1/messages</c>) never went through MediatR/<c>Result&lt;T&gt;</c> —
/// it calls <c>IMessageService.SendMessageAsync</c> directly, both before and after this task, matching
/// Provider's own <c>GetProviderReport</c> precedent (a route this service's Clean Architecture split
/// deliberately leaves untouched). This type is a real, live request DTO bound straight from the endpoint
/// body — not a leftover from a deleted handler.
/// </para>
/// </remarks>
