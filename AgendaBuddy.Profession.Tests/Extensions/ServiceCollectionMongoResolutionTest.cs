...
using System.Linq;
using AgendaBuddy.Profession.Extensions;
...
namespace AgendaBuddy.Profession.Tests.Extensions;

/// <summary>
/// R-3 guards for Profession: one of seven services being left on the old configuration path is the
...
public class ServiceCollectionMongoResolutionTest
{
    ...
    private static IConfiguration LegacyOnly() =>
        Config(("MongoDB:ConnectionString", "mongodb://localhost:27017"),
            ...
            ("MongoDB:ProfessionsCollection", "legacy_professionscollection"),
    ...
    public void AddMongoDbRepository_RegistersRepositories_FromAspireConfigurationAlone()
    {
        ...
        Assert.NotNull(scope.ServiceProvider.GetService<IRepository<ProfessionEntity>>());
